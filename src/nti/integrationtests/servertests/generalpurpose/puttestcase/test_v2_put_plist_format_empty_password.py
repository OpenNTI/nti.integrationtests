...
class V2Server401PlistFormatEmptyPasswordPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V2Constants()
		super(V2Server401PlistFormatEmptyPasswordPutTestCase, self).__init__(ServerTestV2, self.constants_object, *args, **kwargs)

	def test_Server401PlistFormatEmptyPasswordPutTestCase(self):
		self.unauthorizedPutTestPlistFormat(password=self.constants_object.emptyPassword, bodyDataExtracter=URL_DefaultV2())
