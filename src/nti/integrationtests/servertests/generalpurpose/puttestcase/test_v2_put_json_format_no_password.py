...
class V2Server401JsonFormatNoPasswordPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V2Constants()
		super(V2Server401JsonFormatNoPasswordPutTestCase, self).__init__(ServerTestV2, self.constants_object, *args, **kwargs)

	def test_Server401JsonFormatNoPasswordPutTestCase(self):
		self.unauthorizedPutTestJsonFormat(password=self.constants_object.noPassword, bodyDataExtracter=URL_DefaultV2())
