...
class V3_QuizzesServer401JsonFormatIncorrectPasswordPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V3Constants_Quizzes()
		super(V3_QuizzesServer401JsonFormatIncorrectPasswordPutTestCase, self).__init__(ServerTestV3_quizzes, self.constants_object, *args, **kwargs)

	def test_Server401JsonFormatIncorrectPasswordPutTestCase(self):
		self.unauthorizedPutTestJsonFormat(password=self.constants_object.incorrectPassword)
