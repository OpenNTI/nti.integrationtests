...
class V2Server401PlistFormatIncorrectPasswordPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V2Constants()
		super(V2Server401PlistFormatIncorrectPasswordPutTestCase, self).__init__(ServerTestV2, self.constants_object, *args, **kwargs)

	def test_Server401PlistFormatIncorrectPasswordPutTestCase(self):
		self.unauthorizedPutTestPlistFormat(password=self.constants_object.incorrectPassword, bodyDataExtracter=URL_DefaultV2())
