...
class V2Server401JsonFormatEmptyPasswordPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V2Constants()
		super(V2Server401JsonFormatEmptyPasswordPutTestCase, self).__init__(ServerTestV2, self.constants_object, *args, **kwargs)

	def test_Server401JsonFormatEmptyPasswordPutTestCase(self):
		self.unauthorizedPutTestJsonFormat(password=self.constants_object.emptyPassword, bodyDataExtracter=URL_DefaultV2())
