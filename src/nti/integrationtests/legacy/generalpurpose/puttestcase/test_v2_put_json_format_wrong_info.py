...
class V2Server500JsonFormatWrongInfoPutTestCase(PutTests):
	...
	def __init__(self, *args, **kwargs):
		...
		super(V2Server500JsonFormatWrongInfoPutTestCase, self).__init__(ServerTestV2, self.constants_object, *args, **kwargs)

	def test_Server500JsonFormatWrongInfoPutTestCase(self):
		self.wrongTypePutTestJsonFormat(data=self.constants_object.WRONG_INFO, bodyDataExtracter=URL_DefaultV2())
