...
class V3_QuizzesServer201JsonFormatNonExistIDPutTestCase(PutTests):

	def __init__(self, *args, **kwargs):
		self.constants_object = V3Constants_Quizzes()
		super(V3_QuizzesServer201JsonFormatNonExistIDPutTestCase, self).__init__(ServerTestV3_quizzes, self.constants_object, *args, **kwargs)

	def test_Server201JsonFormatNonExistIDPutTestCase(self):
		self.successfulAddPutTestJsonFormat(url=self.constants_object.URL_NONEXIST_ID)
